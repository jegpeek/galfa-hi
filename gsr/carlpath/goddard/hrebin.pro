...
;	HREBIN
; PURPOSE:
;	Expand or contract a FITS image using REBIN and update the header array 
; EXPLANATION:
;	The size of the new image must be an integer factor of 
...
;  If an image array supplied then apply the IDL REBIN function
