...
;	then the ROUTINE_NAMES() function is used to determine if it is an
...
;	Now uses intrinsic EXPAND_PATH() command  W. Landsman November 1994
...
; Now check if it is an intrinsic IDL procedure or function.  
  ...
  funcnames = routine_names( S_Procedures = -1)
