...
;
    ...
    if s[1] gt 1 then begin
        ...
        if (za eq 1)then begin
            ...
            stripsxy,x,bza.d[*,0],0,step,over=overl,color=3,xtitle='amin',$
                _extra=e
            ...
            stripsxy,x,bza.d[*,1],0,step,over=overl,color=5,_extra=e
        ...
        if (az eq 1) then begin
            ...
            if (lpol and 2) ne 0 then begin
                ...
                oplot,x,baz.d[*,1],color=2,_extra=e
                note,4,'az polB',col=2,xp=xp
            endif
        endif
        if (za eq 1) then begin
            if (lpol and 1) ne 0 then begin
                ...
                oplot,x,bza.d[*,0],color=3,_extra=e
                note,5,'za polA',col=3,xp=xp
            endif
            if (lpol and 2) ne 0 then begin
                if overl eq 0 then begin 
                ...
                oplot,x,bza.d[*,1],color=5,_extra=e
                note,6,'za polB',col=5,xp=xp
            endif
        endif
    endelse
