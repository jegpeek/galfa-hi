...
; az terms
    ...
    line[1]=$
    string(format='("f(1az): ",f8.5,"*cos(1az) + (",f8.5,")*sin(1az)")',$
        fitI.coef[4],fitI.coef[5])

    if fiti.fittype ne 5 then begin
    line[2]=$
    string(format='("f(2az): ",f8.5,"*cos(2az) + (",f8.5,")*sin(2az)")',$
        fitI.coef[6],fitI.coef[7])

    line[3]=$
    string(format='("f(3az): ",f8.5,"*cos(3az) + (",f8.5,")*sin(3az)")',$
    ...
    string(format='("f(3az): ",f8.5,"*cos(3az) + (",f8.5,")*sin(3az)")',$
        fitI.coef[6],fitI.coef[7])
    line[3]=$
    string(format='("f(3az): ",f8.5,"sin(za-10)*cos(3az) + (",f8.5,")*sin(za-10)*sin(3az)")',$
        fitI.coef[8],fitI.coef[9])
    endelse

    line[4]= string(format='("SigCof: za ",f8.5,f8.5,f8.5,f8.5)',$
    fitI.sigmaCoef[0],fitI.sigmaCoef[1],fitI.sigmaCoef[2],fitI.sigmaCoef[3]) 
    line[5]= string(format='("        az ",f8.5,f8.5,f8.5,f8.5,f8.5,f8.5)',$
    fitI.sigmaCoef[4],fitI.sigmaCoef[5],fitI.sigmaCoef[6],fitI.sigmaCoef[7],$
            fitI.sigmaCoef[8],fitI.sigmaCoef[9])
