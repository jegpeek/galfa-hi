...
tcalxx_board = -[ 10.77,10.81,10.64,10.33]
tcalyy_board = -[ 9.18, 9.38, 9.32, 9.62]

tcalxx_board = -[ 6.76]
tcalyy_board = -[ 6.9]
;; {4500l1 4860h2 5000h2 5400h3
tcalxx_board =-[ 40.  ,38.0, 38.2,34.0]
tcalyy_board =-[ 30.  ,28.5, 28.2,22.4]
