...
;
    ...
    mmplotsrc,az,zaErr,mm,col=col,xtitle='az',ytitle='zaErr [asecs]',$
        title='za error vs az',charsize=cs,/nolab,rise=rise
...
;
    ...
    mmplotsrc,za,azErr,mm,col=col,xtitle='za',ytitle='azErr [asecs]',$
        title=' az error vs za',charsize=cs,/nolab,rise=rise
;
;   azErr versus az
;
    hor,haz[0],haz[1]
    ...
    mmplotsrc,az,azErr,mm,col=col,xtitle='az',ytitle='azErr [asecs]',$
        title='az error vs az',charsize=cs,/nolab,rise=rise
    flag,[0,180],linestyle=2
;
...
;
        ...
        title='total error vs za',charsize=cs,/nolab,rise=rise
;
;   totErr versus az
;
        hor,haz[0],haz[1]
        ...
        mmplotsrc,az,totErr,mm,col=col,xtitle='az',ytitle='totErr [asecs]',$
            title='total error vs az',charsize=cs,/nolab,rise=rise
        flag,[0,180],linestyle=2
    endif
;
; label the mean, rms
