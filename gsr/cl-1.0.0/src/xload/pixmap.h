...
void    gexit(int n);
void    tty_to_raw(void);
void    tty_to_cooked(void);
int     kbhit(void);
int     readch(void);

void    pixmap_init(void);
void    pixmap_close(void);
...
#ifdef PM_VNC
void    pixmap_init_vnc(int *ac, char **av, int width, int height);
void    pixmap_vnc_mark_rect(pixmap *pm, int xo, int yo, int xs, int ys);
#endif
