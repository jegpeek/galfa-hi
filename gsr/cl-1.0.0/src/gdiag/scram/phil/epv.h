...
/* taken from Revision 1.1  2004/10/27 18:15:24  jeff
/* taken from
/* taken from
/* taken from Capture scramnet packets, added display in user interface using
/* taken from offset freq determined from scramnet net (and -lo2 option).
/* taken from
/* taken from Putting scramnet params in FITS files isn't implemented yet.
/* taken from
