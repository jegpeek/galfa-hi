...
pro moveblankssp, blankfile, mht
...
for i=0, sz[2]-1 do begin
    ...
    hg = histogram(mht.utcstamp, min=blanks[0,i], binsize=blanks[1,i]-blanks[0,i]+1, nbins=1, reverse_indices=ri)
    wh = ri[ri[
