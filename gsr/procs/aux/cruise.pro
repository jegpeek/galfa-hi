pro cruise, cube, v, mask=mask, vrng=vrng, cont=cont, level=level, ra0=ra0, dec0=dec0, xdata=xdata, ydata=ydata, _REF_EXTRA=_extra
...
while !mouse.button ne 1 do begin
    ...
    v = (x*sz[3] < sz[3]) > 0.
    display, cube[*, *, v]*mask, ra0, dec0, aspect=1., /silent
