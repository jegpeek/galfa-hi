pro gsrplot_beam2d, beamout, windowsize, $
...
;NTERMS=8 forces the reconstruction to duplicate the measured points
...
;
;	USe either NTERMS=8 or NTERMS ODD.
;
;09dec2004: the default for nterms changed from 6 to 3.
;021dec2004: the default for nterms changed from 3 to 8.
;
;-
...
gsrsidelobe_eval, nterms, beamout.fhgt, beamout.fcen, beamout.fhpbw, $
