...
;
;COMMENT AND NOTE
;	the matching up of the nb and wb intensity scales is crucial because
...
;GET THE POLYUNCORRECTED SPECTRAL INTEGRALS BY TAKING MEAN OF BINNED SPECTRA...
pnb_uc[ nrprx, nsp]= mean( spnb_c_bin)
pwb_uc[ nrprx, nsp]= mean( spwb_c_bin)
...
swb_c[ *, nrprx, nsp]= spwb_c- rfpoly_wb
