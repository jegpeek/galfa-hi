pro find_smartf, mhpath, fitsfiles, smartf

;+
;FIND_SMARTF: given a set of fits files (inputfiles) that have 
;a corresponding set of mh files located in mhpath, use the mh files
;to find all files containing data having mh.obsmode eq SMARTF. we
...
;2008 may 2: 'SMARTF' changed to 'SMARTF  ' by JEGP. 
