pro feedbad, mhpath, mhfilelist, juldanrange=juldayrange, $
...
;+
;NAME:
;FEEDBAD -- input mh files, look at the bad-feed diagnostic
;
;CALLING SEQUENCE:
;feedbad, mhpath, mhfilelist, juldanrange=juldayrange, $
;	noprint=noprint, nodoc=nodoc, noplot=noplot, $
;	writesave=writesave, readsave=readsave, $
;	mxx=mxx, mxindxrange=mxindxrange
;INPUTS
...
MXFEEDLOOK:
mxfeedlook, mxx, juldayrange, mxindxrange
