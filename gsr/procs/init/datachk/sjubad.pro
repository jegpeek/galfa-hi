pro sjubad, mhpath, mhfilelist, juldanrange=juldayrange, $
...
;+
;NAME:
;SJUBAD -- input mh files, look at the sju diagnostic
;
;CALLING SEQUENCE:
;sjubad, mhpath, mhfilelist, juldanrange=juldayrange, $
;        noprint=noprint, nodoc=nodoc, noplot=noplot, $
;        writesave=writesave, readsave=readsave, $
;        mxx=mxx, mxindxrange=mxindxrange
;
...
MXRMSLOOK:
mxsjulook, mxx, juldayrange, mxindxrange
